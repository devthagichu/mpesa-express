...
class Mpesa {
    ...
    async _getAuthToken() {
        ...
        let auth: string = "Basic " + new Buffer.from(this.consumer_key + ":" + this.consumer_secret).toString("base64")
    ...
    async sktPush(Amount: number, PhoneNumber: number, AccountReference: string, TransactionDesc: string) {
